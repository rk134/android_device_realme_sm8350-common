...
COMMON_PATH := device/realme/sm8350-common
...
BOOT_KERNEL_MODULES := $(strip $(shell cat $(COMMON_PATH)/configs/modules/modules.include.recovery))
...
include vendor/realme/sm8350-common/BoardConfigVendor.mk
